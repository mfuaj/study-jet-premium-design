  ...
  return (
    <section id="partners" className="py-24 lg:py-32 bg-muted">
      <div className="container mx-auto px-6">
        <div ref={reveal.ref} className={`max-w-4xl mx-auto text-center transition-all duration-700 ${reveal.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <p className="text-gold font-body text-sm uppercase tracking-[0.25em] mb-4">Our Network</p>
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-semibold text-primary mb-6">Our Partners</h2>
          ...
          <div className="bg-card p-10 lg:p-14 rounded-lg shadow-card border border-border/50">
            ...
            <p className="font-body text-primary font-medium mb-8">Interested in partnering with us?</p>
            <Button variant="gold" size="lg">Contact Us to Learn More</Button>
          </div>
        </div>
      </div>
    </section>
